                            ...
                            <div class="col-12">
                                <div class="block block-rounded block-bordered block-mode-hidden" v-for="goal in data.goals" :key="goal.id">
                                    ...
                                    <div class="block-content hide">
                                        <div class="form-group">
                                            <label for="services">Storitve, ki jih nudijo:</label>
                                            <textarea class="form-control" id="services" rows="3" v-model="goal.pivot.services"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="possibilities">Možnost aplikacije v prakso:</label>
                                            <textarea class="form-control" id="possibilities" rows="3" v-model="goal.pivot.possibilities"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSave() {
                axios.post('institutes/' + this.data.id, {_method: 'put', data: this.data })
                    .then(response => {
