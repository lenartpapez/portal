...
<div class="fullscreen">
    ...
    <form method="POST" action="{{ route('password.email') }}" class="form-login">
        @csrf
        <ul class="login-nav text-center mb-4">
            <li class="login-nav__item active">
                <a>Ponastavitev gesla</a>
            </li>
        </ul>
        <p class="text-center" class="login--reset" style="color: #fff; margin-bottom: 30px; font-size: .9rem">Vnesite
            email, s katerim ste se registrirali. Na vaš naslov boste prejeli navodila za ponastavitev gesla.</p>
